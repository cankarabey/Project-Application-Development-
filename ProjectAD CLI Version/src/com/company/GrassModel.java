...
public class GrassModel {
    ...
    public static TreeMap<Integer, String> getGrass(int t, String path) throws IOException{
        Double GP = CSVReader.getGrowthPotential(path); //gets grass height difference from year before
        int temp0 = 20;
        int avgTemp = 10;
        for (int i = 0 ; i <= t; i++) {
            ...
            GP = GP - CSVReader.calcR("CattleData.csv") - CSVReader.calcR("DeerData.csv") - CSVReader.calcR("HorseData.csv");
        }
        return grass;
    }
}